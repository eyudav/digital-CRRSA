...
export function Logo({ variant = "dark" }) {
    ...
    return (<Link to="/" className={`group inline-flex items-center gap-2.5 ${tone}`}>
      <span className="grid h-9 w-9 place-items-center overflow-hidden rounded-lg shadow-soft transition-transform group-hover:scale-105">
        <img src="/crrsa-logo.png" alt="Digital CRRSA logo" className="h-full w-full object-cover"/>
      </span>
