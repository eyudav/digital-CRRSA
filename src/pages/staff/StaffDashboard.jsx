...
const StaffDashboard = () => {
  ...
  const kpis = [
    ...
    },
    {
      ...
      value: complaints.filter((c) => c.statusUi !== "resolved").length,
      icon: Users,
  ...
  return (
    <>
      <PageHeader
        eyebrow={`Officer · ${user?.fullName.split(" ")[0]}`}
        title="Operations overview"
        description="Triage incoming applications, manage today's queue and respond to citizens quickly."
      />
                  ...
                  >
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-xs text-muted-foreground">
                        {a.refNumber} · {a.citizenName}
                      </p>
                    </div>
                    <p className="hidden text-xs text-muted-foreground md:block">
                      Submitted {format(new Date(a.submittedAt), "MMM d")}
                    </p>
