    ...
    return (
        <>
            <PageHeader
                ...
                description="Manage users across roles, view detailed system logs, and configure platform settings."
            />
            ...
            <div className="mt-8 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                <Link to="/staff/admin/users" className="group rounded-2xl border border-border bg-card p-6 shadow-soft hover:border-primary">
                    <div className="flex items-center justify-between">
                        <h3 className="font-display text-lg font-semibold group-hover:text-primary">Manage users</h3>
                        <Users className="h-5 w-5 text-muted-foreground group-hover:text-primary" />
                    </div>
                    <p className="mt-2 text-sm text-muted-foreground">Citizens, staff, and administrators: search, edit, and deactivate accounts.</p>
                </Link>
