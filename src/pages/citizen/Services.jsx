...
const Services = () => {
    ...
    return (<>
      ...
      <div className="mb-6 flex flex-col gap-3 md:flex-row md:items-center">
        <SearchInput value={q} onChange={setQ} placeholder="Search services..." />
        <FilterBar options={cats} currentFilter={cat} onFilterChange={setCat} />
      </div>
      ...
      <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
        {filtered.map((s) => {
            ...
            return (
              <Card key={s.id} className="group flex flex-col transition-all hover:-translate-y-1 hover:shadow-elegant border-border shadow-soft">
                <CardContent className="p-6 flex flex-col h-full">
                  ...
                  <Button asChild className="mt-5 w-full bg-primary text-primary-foreground hover:bg-primary/90 mt-auto">
